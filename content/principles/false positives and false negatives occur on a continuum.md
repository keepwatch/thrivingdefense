...
[[content/people/Jared Atkinson|Jared Atkinson]] shared [a tool](https://dprime-calculator.vercel.app/) that makes this more obvious - try it out! Changing the criterion value within this tool changes the evidence range within which a signal will be reported, changing all of the rates from the above table.