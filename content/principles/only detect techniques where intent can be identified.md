...
| Account Manipulation (small org) | Low                                                         | Low — account changes should generally be modified by a set of admins or service accounts                                                                                                    | Difficult  — native logs will not make it clear what the desired objective was                                                                                                                                                        |
| Account Manipulation (large org) | High                                                        | Low — account changes should generally be made with intention and by an administrator                                                                                                        | Easy  — changes should be made through a system with change auditing & notes available                                                                                                                                                |
(I threw in a few bonus techniques at the end in case you wondered if any techniques remain to be detected 😏). Interestingly, the Account Manipulation case should be detectable in both large and small organizations, but for different reasons.
