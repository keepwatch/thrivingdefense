...
Of course, it's hard to build something [[Mutually Exclusive and Collectively Exhaustive (MECE)]], and far easier to create a new matrix ([relevant XKCD](https://xkcd.com/927/)), so there are several other matrices with unclear levels of overlap. This page will at least assemble them, and eventually we'll figure out how to deduplicate them for [[ACRE (ATT&CK Coverage Ratio Evaluation)|ACRE]] purposes.
