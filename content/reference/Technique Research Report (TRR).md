...
Another reason for creating the TRRs is to ensure the detection *context* is recorded, not just the rule. The appropriate context helps detection engineers manage and tune the rule as environmental circumstances change (see also [[Managing human context windows]] for how this challenge extends to organizational knowledge management more broadly).
